...
class SilhouetteMiniBatchKMeans(
    sklearn.base.BaseEstimator, sklearn.base.ClusterMixin, sklearn.base.TransformerMixin
):
    def __init__(
        self,
        max_n_clusters=8,
    ...
    def fit(self, X, y=None, sample_weight=None):
        ...
        for n_clusters in range(1, self.max_n_clusters):
            ...
            if n_clusters == 1:
                ...
                silhouette_avgs.append(
                    silhouette_score(X, self.clusterers[n_clusters - 1].labels_)
                )
        ...
        self.cluster_centers_ = self.clusterers[
